...
cred = credentials.Certificate('key/keylau.json')
# Initialize the app with a service account, granting admin privileges
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://iotsystem1.firebaseio.com/'
})
...
b=Label(marco1,text="")
img = Image.open("C:/Users/Labing/Desktop/gatito1.png")
img = img.resize((150,150), Image.ANTIALIAS)
photoImg=  ImageTk.PhotoImage(img)
b.configure(image=photoImg)
b.place(x = 760,y = 20)

valor= Label(marco1, bg='blue', font=("Arial Bold", 15), fg="white", width=5)
variable=StringVar()
valor2= Label(marco1, bg='blue', font=("Arial Bold", 15), fg="white", width=5)
adc_data=StringVar()
